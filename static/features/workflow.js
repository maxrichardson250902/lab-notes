...
function _wfInjectDocStyles() {
  ...
  s.textContent = [
    ...
    /* Gel embed — kept in sync with the copy in wf_editor.js's
       ...
       image would inherit the broad `.wf-read-day-body img` rule above
       and render OK on width but with none of the card framing / caption
       styling / cursor affordance. The scoped `.wf-read-day-body a.wf-gel-link img`
       selector below beats that rule (0,2,1 vs 0,1,1) so we control
    ...
    'a.wf-gel-link .wf-gel-thumb, .wf-read-day-body a.wf-gel-link img { display:block; width:auto; height:auto; max-width:100%; max-height:520px; margin:0 auto; border-radius:4px; background:#faf8f4; }',
